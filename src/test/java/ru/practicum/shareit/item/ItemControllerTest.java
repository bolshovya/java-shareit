...
class ItemControllerTest {
    ...
    void update() throws Exception {
        Mockito.when(
                itemService.update(Mockito.anyLong(), Mockito.anyLong(), Mockito.any(ItemDto.class)))
                .thenReturn(expectedItem);
        ...
        Mockito.verify(
                itemService,
                Mockito.times(1))
                .update(Mockito.anyLong(), Mockito.anyLong(), Mockito.any(ItemDto.class));
    }
    ...
    void search() throws Exception {
        Mockito.when(
                itemService
                        .search(Mockito.any(), Mockito.anyLong()))
                .thenReturn(List.of(expectedItem));
    ...
    void createComment() throws Exception {
        Mockito.when(
                itemService
                        .createComment(Mockito.any(CommentDto.class), Mockito.anyLong(), Mockito.anyLong()))
